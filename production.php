...
<br>
    ...
    <div id="Location" class="tabcontent">
        ...
        <p>FPIP Sto.Tomas Batangas</p>
    </div>

    <div id="Qualification" class="tabcontent">
        <h3>Qualification</h3>
        <p>●   Can understand work instruction</p>
        <p>●   Highschool/Vocational/College Graduate</p>
    ...
    <div id="Requirements" class="tabcontent">
        ...
        <p>●   Resume</p>
        <p>●   Job Application</p>
        <p>●   Certificates or Documentation of Qualification</p>
    </div>
    ...
    <div id="Benefits" class="tabcontent">
        ...
        <p>●   OverTime Pay</p>
        <p>●   Bonuses base on performances</p>
    </div>
