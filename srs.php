...
<div class="main">
    ...
    <br>
    <br>
    <h1>SENIOR RECEIPTION SUPERVISOR</h1>
    <div class="tab">
    ...
    <div id="Location" class="tabcontent">
        ...
        <p>Light&Hope Overseas Placement Agency 105 Pearl of the Orient Tower, Roxas Blvd.,</p>
    </div>
    ...
    <div id="Requirements" class="tabcontent">
        <h3>Requirements</h3>
        <p>●   Updated Resume with 2x2 picture</p>
        <p>●   Valid Passport</p>
