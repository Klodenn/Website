...
<br>
    ...
    <div id="Location" class="tabcontent">
        <h3>Location</h3>
        <img src="pics/liho.jpg" alt=" ">
        <p>Public Employment Service Office (PESO), 2/F, Municipal Government Building, Mbini, Batangas</p>
    </div>

    <div id="Qualification" class="tabcontent">
        <h3>Qualification</h3>
        <p>●   18 - 40 years old</p>
        <p>●   Hold Current Nursing Registration</p>
        <p>●   Have Previous Experience</p>
        <p>●   Often interact with customers</p>
    </div>
